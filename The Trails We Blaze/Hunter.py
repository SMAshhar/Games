# # # This is the third string of the same game, designed on the same map # # #
...
while asd.lower() != "q":
    ...
    while Hunter.HP > 0 and y.HP > 0:       # First level loop, enters into battle with a new monster
        ...
        if ability.lower() == "poison":        # The whole full loop was made just if poison ability was active.
            x = 5                              # Could be done with fewer lines
